...
public class ChargeBalanceRequest {
    ...
    @Schema(description = BalanceSchemaDescription.userId, example = "1001", required = true)
    @NotNull(message = "사용자 ID는 필수입니다.")
    private Long userId;

    @Schema(description = BalanceSchemaDescription.chargeAmount + " (최대 1,000,000원)", example = "10000", required = true)
